...
function FloatingNavItem({ to, label, icon }: FloatingNavItemProps) {
  return (
    <NavLink to={to} className="-translate-y-2.5 mx-1.5">
      {({ isActive }) => (
        <div className="h-[3.687rem] w-[3.687rem] flex flex-col items-center justify-center bg-nav-gradient rounded-full space-y-0.5">
