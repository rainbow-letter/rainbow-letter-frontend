...
export default function LoginBox() {
  return (
    <article className="mt-5 border rounded-[15px] border-gray-3 px-[17px] flex flex-col items-center">
      ...
      <div className="flex w-full h-[61px] mt-[18px] mb-4 text-solo-large gap-4">
        <Link to="/login" className="w-full">
          <button
            type="button"
            className="w-full h-full py-5 px-[22px] bg-orange-400 text-white rounded-[15px]"
          >
            {USER_ACTIONS.LOGIN}
          </button>
        </Link>
        <Link to="/sign-up" className="w-full">
          <button
            type="button"
            className="w-full h-full py-5 px-[22px] text-orange-400 border-orange-400 border-2 rounded-[15px]"
          >
